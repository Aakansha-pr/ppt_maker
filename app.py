...
if not all(ALL_API):
  st.sidebar.error("Must give all API keys")
...
def search_latest_info(query):
  """This function helps to give latest search using tavily
...
def generate_image(img_prompt,slide_no=1):
  """This function helps user to generate img using
  free api, with given img_prompt, with slide no"""
...
tab1,tab2,tab3 = st.tabs(["Generate Image","Fetch News","Generate PPTs"])
